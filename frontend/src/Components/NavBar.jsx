      ...
      <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50 p-2.5">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          ...
          <ul className="hidden md:flex items-center gap-6 text-gray-700 font-medium">
            ...
            <Link to="/shop"><li className="hover:text-red-500">Shop</li></Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 top-full mt-1 hidden group-hover:flex flex-col bg-white shadow-lg rounded-md py-2 w-48 z-50 border">
                <Link to="/menu" className="px-4 py-2 hover:bg-red-100">Food Menu</Link>
                <Link to="/gallery" className="px-4 py-2 hover:bg-red-100">Gallery</Link>
                <Link to="/services" className="px-4 py-2 hover:bg-red-100">Services</Link>
                <Link to="/testimonials" className="px-4 py-2 hover:bg-red-100">Testimonial</Link>
                <Link to="/reservations" className="px-4 py-2 hover:bg-red-100">Reservations</Link>
                <Link to="/faqs" className="px-4 py-2 hover:bg-red-100">FAQ's</Link>
                <Link to="/account" className="px-4 py-2 hover:bg-red-100">My Account</Link>
              </div>
            </div>

            <Link to="/contact"><li className="hover:text-red-500">Contact</li></Link>
            <Link to="/blog"><li className="hover:text-red-500">Blog</li></Link>
          </ul>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/account" className="hidden md:block bg-red-500 text-white py-1 px-4 rounded-md hover:bg-red-600 transition">
              Login
            </Link>
            {/* Menu Icon - Mobile */}
            <Menu
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-0 left-0 w-full h-full bg-white z-50 flex flex-col gap-6 px-6 py-8">
          <div className="flex justify-between items-center">
            ...
            <X className="w-6 h-6 text-gray-700 cursor-pointer" onClick={() => setIsMobileMenuOpen(false)} />
          </div>
          ...
          <nav className="flex flex-col gap-4 text-lg font-medium text-gray-800">
            ...
            <Link to="/menu" onClick={() => setIsMobileMenuOpen(false)}>Food Menu</Link>
            ...
            <Link to="/login" className="bg-red-500 text-white text-center py-2 rounded-md hover:bg-red-600 transition">
              Login
            </Link>
          </nav>
