      ...
      <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50 p-2.5">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            {/* Cart Icon - now always visible */}
            <div className="relative cursor-pointer">
              <ShoppingCart
                onClick={() => navigate("myaccount/cart")}
            ...
            {token === "" ? (
              ...
              <Link to="/myaccount/dashboard" className="hidden md:block">
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-0 left-0 w-full h-full bg-white z-50 flex flex-col gap-6 px-6 py-8">
          ...
          <nav className="flex flex-col gap-4 text-lg font-medium text-gray-800">
            ...
            <Link to={adminToken === "" ? "/admin" : "/myadmin/dashboard"} onClick={() => setIsMobileMenuOpen(false)}>Admin</Link>
