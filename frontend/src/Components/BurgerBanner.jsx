...
function BurgerBanner() {
  return (
    <div className="flex flex-col md:flex-row gap-4 px-4 py-6">
      {/* Banner 1 */}
      <motion.div
        className="flex-1 h-64 bg-cover bg-center rounded-lg relative overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between h-full p-4">
          ...
          <img
            src={friedimg}
            alt="fried chicken"
            className="w-[110px] h-[140px] sm:w-[100px] sm:h-[150px] object-contain mt-4 sm:mt-0"
          />
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between h-full p-4">
          ...
          <img
            src={pizzaimg}
            alt="pizza"
            className="w-[110px] h-[140px] sm:w-[150px] sm:h-[150px] object-contain mt-4 sm:mt-0"
          />
        </div>
      </motion.div>
